...
const config = {
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/AIDD/humanoid-robotic-book-frontend/tree/main/',
        },
        blog: false,
        theme: {
  ...
  plugins: [
    ...
    [
      ...
      {
        hashed: true,
        language: ['en'], // Removed 'ur' since the Urdu language pack is not available
        // Optional: Adjust the index page by markdown content
        indexBlog: true,
        indexDocs: true,
        indexPages: true,
      },
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/AIDD/humanoid-robotic-book-frontend',
            label: 'GitHub',
            position: 'right',
          },
        ],
